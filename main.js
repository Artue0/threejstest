...
// Background
import spaceSrc from './assets/space.jpg';

const spaceTexture = new THREE.TextureLoader().load(spaceSrc);
scene.background = spaceTexture;

// Avatar
import jeffSrc from './assets/jeff.png';

const jeffTexture = new THREE.TextureLoader().load(jeffSrc);
